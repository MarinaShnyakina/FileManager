            ...
            public void onClick(View v) {
                if (selectedFile.isDirectory()) {
                    ...
                    try {
                        ...
                        Toast.makeText(context.getApplicationContext(), "Не могу открыть файл", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        if(item.getTitle().equals("УДАЛИТЬ")) {
                            ...
                            if(deleted){
                                Toast.makeText(context.getApplicationContext(), "УДАЛИТЬ ", Toast.LENGTH_SHORT).show();
                                v.setVisibility(View.GONE);
                            }
                        }
                        if(item.getTitle().equals("ОТПРАВИТЬ")) {
                            Toast.makeText(context.getApplicationContext(), "ОТПРАВИТЬ ", Toast.LENGTH_SHORT).show();
                        }
                        if(item.getTitle().equals("ПЕРЕИМЕНОВАТЬ")) {
                            Toast.makeText(context.getApplicationContext(), "ПЕРЕИМЕНОВАТЬ ", Toast.LENGTH_SHORT).show();
                        }
                        return true;
                    }
                });
